                ...
                allComment.map((comment) => ( <
                        ...
                        div style = {
                            ...
                            comment.isAdmin ? ( <
                                ...
                                div className = "all-comment-info-name" > { getFirstCharacterUser(comment.author) } <
                                /div>
                            )
                        } {
                            comment.isAdmin ? ( <
                                strong > { comment.author } < span > QTV < /span> <
                                /strong>
                            ) : ( <
...

                        {
                            ...
                            /div> {
                                comment.replies.length > 0 ? ( <
                                    AllRepComment allrepcomment = { comment.replies }
                            ...
                            /Col> {
                                repCmt.status === true && repCmt.key === comment._id ? ( <
                                    ...
                                    <
                                    textarea placeholder = "Xin mời để lại câu hỏi, CellphoneS sẽ trả lời trong 1h từ 8h - 22h mỗi ngày."
                                    rows = { 10 }
                                    cols = { 3 }
                                    vaule = { repValue }
                                    onChange = {
                                        (e) => setRepValue(e.target.value) } >
                                    < /textarea> <
                                    /div>
                                    ...
                                    <
                                    button onClick = {
                                        () => handleRepComment() } > Trả lời < /button> <
                                    /div> <
                                    /Col>
                                ) : (
                                    ""
